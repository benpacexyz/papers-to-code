...
# setup data and model directories relative to this file
DATA_DIR = os.path.join(SCRIPT_DIR, '..', 'data')
MODEL_DIR = os.path.join(SCRIPT_DIR, '..', 'models', 'web_phish')
...
# Model Precision: 0.9923
# Model Recall: 0.9989
# Model F1-Score: 0.9956
# Model False Positive Rate (FPR): 0.0036
# Model False Negative Rate (FNR): 0.0011
...
# Model Precision: 0.9665
# Model Recall: 0.9542
# Model F1-Score: 0.9603
# Model False Positive Rate (FPR): 0.0329
# Model False Negative Rate (FNR): 0.0458
